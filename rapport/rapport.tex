...
$q \vDash p$ &ssi& $p$ est une étiquette de $\sigma(i)$\\
$q \vDash \neg \psi$ &ssi& $q_i$ ne vérifie pas $\phi$\\
$q \vDash \psi_1 \land \psi_2$ &ssi& $q_i$ vérifie $\phi_1$ et $q_i$ vérifie $\phi_2$\\
$q \vDash \psi_1 \lor \psi_2$ &ssi& $q_i$ vérifie $\phi_1$ ou $q_i$ vérifie $\phi_2$\\
$q \vDash \mbox{EX } \psi$ &ssi& il existe un successeur de $q_i$ vérifiant $\psi$\\
$q \vDash \mbox{AX } \psi$ &ssi& tous les successeurs de $q_i$ vérifient $\psi$\\
$q \vDash \mbox{E } \psi_1 \mbox{ U } \psi_2$ &ssi& il existe un chemin à partir de $\sigma(i)$ tel que $\psi_1$\\&& est vrai jusqu'à ce que $\psi_2$ le soit (et il le sera un jour)\\

$q \vDash \mbox{A } \psi_1 \mbox{ U } \psi_2$ &ssi& pour tout chemin partant de $q_i$, $\psi_1$ est vrai \\&& jusqu'à ce que $\psi_2$ le soit (et il le sera un jour)\\

$q \vDash \mbox{E } \psi_1 \mbox{ W } \psi_2$ &ssi& il existe un chemin à partir de $q_i$ tel que $\psi_1$\\&& est vrai jusqu'à ce que, peut-être, $\psi_2$ le soit\\

$q \vDash \mbox{A } \psi_1 \mbox{ W } \psi_2$ &ssi& pour tout chemin partant de $q_i$, $\psi_1$ est vrai \\&& jusqu'à ce que, peut-être, $\psi_2$ le soit\\
\end{tabular}
