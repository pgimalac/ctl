...
$\sigma,i \vDash \mbox{EX } \psi$ &ssi& $\exists \sigma'$, $\forall j \in \mathbb{N}$, $j \leq i$, $\sigma(j) = \sigma'(j)$ et $\sigma',i+1 \vDash \psi$\\
$\sigma,i \vDash \mbox{AX } \psi$ &ssi& $\forall \sigma'$, $\forall j \in \mathbb{N}$, $j \leq i$, $\sigma(j) = \sigma'(j)$ et $\sigma',i+1 \vDash \psi$\\
$\sigma,i \vDash \mbox{E } \psi_1 \mbox{ U } \psi_2$ &ssi& \\
$\sigma,i \vDash \mbox{E } \psi_1 \mbox{ U } \psi_2$ &ssi& \\
$\sigma,i \vDash \mbox{A } \psi_1 \mbox{ W } \psi_2$ &ssi& \\
$\sigma,i \vDash \mbox{A } \psi_1 \mbox{ W } \psi_2$ &ssi& \\
