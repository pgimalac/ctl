...
Nous avons implémenté l'algorithme décrit Section \ref{algofpg} en OCaml, le code est disponible à l'adresse suivante: \url{https://github.com/nobrakal/ctl/}\footnote{fork pour la postérité à \url{https://github.com/pgimalac/ctl}}.

\subsection{Model-checking de CTL: marquage}
Nous avons aussi, pour comparaison, implémenté une autre méthode de model-checking de CTL, basée sur le parcours et le marquage de la structure de Kripke. Notre implémentation est une traduction fonctionnelle de l'algorithme décrit par Philippe Schnoebelen et al. \cite{verif}.
