...
Le but ici est de parvenir à créer un jeu à partir d'une formule et d'une structure de Kripke où deux joueurs (nommés Eve et Adam) s'affrontent, et Eve gagne si et seulement si la formule est vraie dans la structure donnée. O

\subsection{Jeux faibles de parité}
On appelle \emph{jeu faible de parité} un quadruplet $G = (V_E, V_A, R, c)$ où:
\begin{itemize}
