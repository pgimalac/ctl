...
$x \in V_k$ est un état gagnant pour $\overline{\gamma}$ si et seulement si:
\begin{itemize}
	\item C'est à $\gamma$ de jouer et il est bloqué ce qui est le cas si $x$ n'a pas de successeur, ou tous ses successeurs sont gagnants pour $\overline{\gamma}$.
	\item C'est à $\overline{\gamma}$ de jouer et il existe un successeur de $x$ qui est gagnant pour $\overline{\gamma}$
\end{itemize} 
TODO
