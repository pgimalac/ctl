...
\begin{itemize}
	...
	\begin{itemize}
		\item Si $v \in Q \times CTL$, $c(s,q) = poids(q)$
		\item Sinon, $c(s,q) = \bot$  %todo poids
	\end{itemize}
\end{itemize}

On peut maintenant définir $R$, la relation de transition. On le fait par induction sur les formules booléennes positives:
\end{document}
